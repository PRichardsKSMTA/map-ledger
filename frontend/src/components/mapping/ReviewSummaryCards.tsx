...
export interface ReviewMetrics {
  ...
  operatingRatioChange: number; // percent change from last month
}
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm">
              ...
              >
                {formatPercentChange(operatingRatioChange)}
              </span>
              <span className="ml-1.5 text-xs text-gray-500 dark:text-gray-400">vs Prior Month</span>
            </p>
          </div>
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm">
              ...
              <span className="mx-1.5 text-xs text-gray-400 dark:text-gray-500">|</span>
              <span
                className={`inline-flex items-center rounded px-1.5 py-0.5 text-xs font-medium ${
                  netIncomeChange >= 0
                    ? 'bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300'
